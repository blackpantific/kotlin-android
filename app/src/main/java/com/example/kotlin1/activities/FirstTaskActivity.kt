...
class FirstTaskActivity : AppCompatActivity() {
    ...
    private var listOfCars: List<Auto> = mutableListOf(
        Auto("Lamborghini", "description", CarIcon.DEFAULT),
        Auto("Audi", "description", CarIcon.DEFAULT),
        Auto("BMW", "description", CarIcon.DEFAULT),
        Auto("Bugatti", "description", CarIcon.DEFAULT),
        Auto("Mercedes", "description", CarIcon.DEFAULT),
        Auto("Bentley", "description", CarIcon.DEFAULT),
        Auto("Ford", "description", CarIcon.DEFAULT),
        Auto("Pagani", "description", CarIcon.DEFAULT),
        Auto("Ferrari", "description", CarIcon.DEFAULT),
        Auto("Ferrari", "description", CarIcon.DEFAULT),
        Auto("Tesla", "description", CarIcon.DEFAULT),
        Auto("McLaren", "description", CarIcon.DEFAULT),
    )
